# MLOps
end to end ML pipeline for ML solutions
...
```bash
https://github.com/prabhav131/MLOps
```
### STEP 01- Create a python virtual environment after opening the repository and then activate it
